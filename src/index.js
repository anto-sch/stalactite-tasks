...
const router = createHashRouter([
  ...
  },
  {
    ...
    <p>The average line of the sector lets you compare the profit margin of an industry to the average profit margin in the sector. In the same way, you can compare the profit margin of a company to the average profit margin in the industry. </p><img src={line_training_1} style={{width: "415px", height: "169px", marginLeft: "auto", marginRight: "auto", display: "block"}}></img><p>With the average line you can easily see which companies have a <span style={{color: "red"}}>below</span> average profit margin and which have an <span style={{color: "green"}}>above</span> average profit margin.</p><img src={line_training_2} style={{width: "415px", height: "169px", marginLeft: "auto", marginRight: "auto", display: "block"}}></img><div style={{textAlign: "center"}}><Link className="button" to="/ttask-8" style={{marginTop: "30px", width: "100px"}}>Got it!</Link></div></div> 
  },
  {
    path: "/ttask-8",
