...
function IntroIcicleEnergy({ task_data, task_text, vis_type }) {
    ...
    return (
        <div style={{ margin: "auto", textAlign: "center" }}>
            ...
            <div style={{position: "absolute", left: 0, right: 0, marginLeft: "auto", marginRight: "auto", bottom: "40px", width: "800px"}}>
                <button className="button" onClick={() =>  navigate("/icicle-ttask-1-energy") }>Continue</button>
            </div>
        </div>
    );
  }
  ...
  export default IntroIcicleEnergy;
